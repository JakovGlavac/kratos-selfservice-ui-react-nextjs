...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      >
        <Stack w="full">
          ...
          <Button w="full" onClick={() => router.push('/recovery')}>
            Recovery
          </Button>
          <Button w="full" onClick={() => router.push('/verification')}>
            Verification
          </Button>
          <Button w="full" disabled={!hasSession} onClick={onLogout}>
            Logout
          </Button>
        </Stack>
      </Container>
    ...
    // <Heading>
    /* {session != 'null' ? 'Logiran' : () => router.push('/login')} */
